...
class Grid extends DOMManipulator{
    ...
    #_init() {
        this.gridContainer.style.width = this.gridContainer.style.height = (this.boxSize * this.gridCount + 4) + 'px';
        ...
        this.#_processGame = setInterval(() => {
            ...
            switch(this.direction) {
                case 'left': {
                    ...
                    if(this.#_snake[0].cell == -1){
                        this.#_snake[0].cell = 12;
                    }
                } break;
                ...
                case 'up': {
                    ...
                    if(this.#_snake[0].row == -1){
                        this.#_snake[0].row = 12;
                    }
                } break;
                ...
                case 'right': {
                    ...
                    if(this.#_snake[0].cell == 13){
                        this.#_snake[0].cell = 0;
                    }
                } break;
